...
export const IconSharePoint = (props: IconProps) => (
  <svg
    {...props}
    viewBox="0 0 32 32"
    fill="none"
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <circle
        ...
        cy="11.5"
        r="9.5"
        fill="url(#paint0_linear_87_7767)"
      ></circle>{" "}
      ...
      <g mask="url(#mask0_87_7767)">
        ...
        <circle
          ...
          cy="23.5"
          r="6.5"
          fill="url(#paint2_linear_87_7767)"
        ></circle>{" "}
        <path
      ...
      <rect
        ...
        height="18"
        rx="2"
        fill="url(#paint3_linear_87_7767)"
      ></rect>{" "}
      <path
      ...
      <defs>
        ...
        >
          {" "}
          <stop stopColor="#103A3B"></stop>{" "}
          <stop offset="1" stopColor="#116B6E"></stop>{" "}
        </linearGradient>{" "}
        <linearGradient
          id="paint1_linear_87_7767"
          x1="18"
          y1="13"
          x2="32"
          y2="21"
        ...
        >
          {" "}
          <stop stopColor="#1D9097"></stop>{" "}
          <stop offset="1" stopColor="#29BBC2"></stop>{" "}
        </linearGradient>{" "}
        <linearGradient
          id="paint2_linear_87_7767"
          x1="12"
          y1="21.5"
          x2="23"
          y2="26.5"
        ...
        >
          {" "}
          <stop stopColor="#28A6B5"></stop>{" "}
          <stop offset="1" stopColor="#31D6EC"></stop>{" "}
        </linearGradient>{" "}
        <linearGradient
          id="paint3_linear_87_7767"
          x1="0"
          y1="16"
          x2="19.5"
          y2="16"
