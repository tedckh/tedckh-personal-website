...
export const IconSignalR = (props: IconProps) => (
  <svg
    {...props}
    id="a7e39c7a-0f50-4fda-b0dc-8e20d54e1945"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 18 18"
  >
    <defs>
      <radialGradient
        id="bb4c4c3f-f7a9-416e-87c4-f79d59529ddb"
        cx="9"
        cy="9"
        r="8.5"
      ...
      <clipPath id="bf38dd48-418e-4b19-93f3-eac77c97feef">
        <path
          id="a2f8fbdd-34b1-4cd6-8ce3-9f41841a5fd9"
          d="M14.21,15.72A8.5,8.5,0,0,1,3.79,2.28l.09-.06a8.5,8.5,0,0,1,10.33,13.5"
          fill="none"
        />
      </clipPath>
    </defs>
    <title>Icon-web-52</title>
    <path
      id="a9e07728-1645-4b38-9a48-dd4b9b350c00"
      d="M14.21,15.72A8.5,8.5,0,0,1,3.79,2.28l.09-.06a8.5,8.5,0,0,1,10.33,13.5"
      fill="url(#bb4c4c3f-f7a9-416e-87c4-f79d59529ddb)"
    />
    <g clipPath="url(#bf38dd48-418e-4b19-93f3-eac77c97feef)">
      <path
